...
export class TalkDataService {
  ...
  private allTalks: Array<Talk> = [
    ...
    this.mock(3, "First prepared", new Date("2018/04/12 16:30:00"), true, "description of first", 1),
    this.mock(4, "Second prepared", new Date("2018/02/23 16:30:00"), true, "description of second", 2),
    this.mock(5, "Third prepared", new Date("2018/05/11 16:30:00"), true, "description of third", 4),
    this.mock(6, "Fourth prepared", new Date("2018/06/03 16:30:00"), true, "description of fourth", 5)
  ];
